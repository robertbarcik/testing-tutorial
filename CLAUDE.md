...
| Path | What |
|---|---|
| `slides/00_intro_testing_by_hand.pptx` | Module 0 deck (20 slides incl. 4 lecture dividers, speaker notes inside). Built by `slides/build_00_intro.py` — edit the script, not the pptx. |
